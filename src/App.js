...
class App extends React.Component {
  constructor(props) {
    ...
    this.setEffects = [
      ...
      /* 1 */ createSetEffect(1, 'Absolute Unit (3) ', 3, [2, 13, 14, 36, 37, 45, 46, 51], 'Players take 50% less damage from monsters, with 100% of post-reduction damage reflected back to the attacker.'),
      /* 2 */ createSetEffect(2, 'The Alchemist', 3, [7, 12, 16, 18, 21, 25, 41], 'When cooking food, making jugs of wine, cleaning grimy herbs, or mixing potions, all items in the player\'s inventory will be processed at once and reward the full amount of experience.'),
      ...
      /* 9 */ createSetEffect(6, 'Drakan\'s Touch (3)', 3, [10, 22, 29, 44, 48, 50, 52], 'Successful hits have a 50% chance of restoring the player\'s hitpoints by 10% of the damage dealt. '),
      /* 10 */ createSetEffect(7, 'Endless Knowledge', 3, [0, 1, 15, 20, 27, 28, 47], 'Players receive an arcane grimoire from The Sage, which allows the ability to freely switch spellbooks anywhere. '),
      /* 11 */ createSetEffect(8, 'Fast Metabolism', 2, [3, 17, 19, 22, 32, 51], 'Hitpoint regeneration is increased by x4.'),
      /* 12 */ createSetEffect(9, 'Greedy Gatherer (2)', 2, [7, 8, 21, 24, 26, 32, 39], 'Players will receive double the resources (with full experience) from Fishing, Woodcutting, Mining, and Farming.'),
      /* 13 */ createSetEffect(9, 'Greedy Gatherer (3)', 3, [7, 8, 21, 24, 26, 32, 39], 'Players will receive triple the resources (with full experience) from Fishing, Woodcutting, Mining, and Farming.'),
      ...
      /* 15 */ createSetEffect(10, 'Knife\'s Edge (3)', 3, [4, 5, 23, 24, 29, 37, 41, 49], 'Players will deal 0.6% additional damage for every hitpoint missing.'),
      /* 16 */ createSetEffect(11, 'Last Recall', 4, [9, 10, 15, 18, 31, 34, 36, 40, 43, 45], 'Players receive a crystal of memories from The Sage, which allows them to teleport themselves back to the location where their most recent teleport occurred, with some caveats regarding its usage.'),
      ...
      /* 18 */ createSetEffect(12, 'Personal Banker (3)', 3, [0, 6, 11, 26, 38, 42], 'Resources obtained from Fishing, Woodcutting, Mining, and Farming are deposited directly to the player\'s bank.'),
